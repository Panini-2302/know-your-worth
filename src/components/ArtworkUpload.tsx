      ...
      <CardContent className="p-6 bg-sky-50">
        <div className="space-y-6 bg-sky-50">
          ...
          <div className="space-y-2">
            ...
            <Textarea id="description" placeholder="Describe your artwork, inspiration, or technique..." value={artwork.description} onChange={e => handleInputChange('description', e.target.value)} className="border-gray-300 focus:border-slate-100 min-h-[100px] bg-sky-50" />
          </div>
        </div>
      </CardContent>
    </Card>;
