...
const PricingBreakdown = ({ valuation }: PricingBreakdownProps) => {
  ...
  const pieData = [
    { name: 'Labor Cost', value: valuation.laborCost || 0, color: '#FFE66D' },
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                { label: 'Labor Cost', value: valuation.laborCost, color: 'bg-yellow-400' },
                ...
                <div key={index} className="flex items-center justify-between p-3 bg-blush-rose/10 rounded-lg">
