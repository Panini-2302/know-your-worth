    ...
    <div className="min-h-screen bg-gradient-to-br from-mist-blue via-white to-lemon-cream/30">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <div className="animate-fade-in">
            <h1 className="text-4xl md:text-6xl font-playfair font-bold text-charcoal-black mb-6">
              Price Your Art with
              <span className="bg-gradient-to-r from-sky-coral to-lemon-cream bg-clip-text text-transparent"> Confidence</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full">
                <Sparkles className="text-sky-coral" size={20} />
                <span className="font-lato font-medium">AI-Powered Analysis</span>
              </div>
              <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full">
                <TrendingUp className="text-lemon-cream" size={20} />
                <span className="font-lato font-medium">Market Insights</span>
              </div>
              <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full">
                <Users className="text-mist-blue" size={20} />
      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            {[
              ...
              <div key={index} className="bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center hover-lift animate-fade-in" style={{ animationDelay: `${0.3 + index * 0.1}s` }}>
                <stat.icon className="text-sky-coral mx-auto mb-3" size={32} />
                <div className="text-2xl font-playfair font-bold text-charcoal-black">{stat.value}</div>
          ...
          {/* CTA Section */}
          <div className="text-center bg-gradient-to-r from-sky-coral to-lemon-cream rounded-2xl p-8 text-white">
            ...
            <Button 
              size="lg" 
              className="bg-white text-sky-coral hover:bg-gray-100 font-lato font-semibold px-8 py-3"
            >
