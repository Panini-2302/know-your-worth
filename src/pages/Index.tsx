    ...
    <div className="min-h-screen bg-gradient-to-br from-cream-beige via-white to-periwinkle-blue/30">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <div className="animate-fade-in">
            <h1 className="text-3xl font-playfair font-bold text-foreground mb-6 md:text-7xl">
              Price Your Art with
              <span className="bg-gradient-to-r from-blush-rose to-periwinkle-blue bg-clip-text text-transparent"> Confidence</span>
            </h1>
            <p className="text-xl font-lato max-w-3xl mx-auto mb-12 text-muted-foreground">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-16">
              <div className="flex items-center gap-3 bg-card backdrop-blur-sm px-6 py-4 rounded-full shadow-lg">
                <Sparkles className="text-blush-rose" size={24} />
                <span className="font-lato font-bold text-lg text-card-foreground">AI-Powered Analysis</span>
              </div>
              <div className="flex items-center gap-3 bg-card backdrop-blur-sm px-6 py-4 rounded-full shadow-lg">
                <TrendingUp className="text-mint-gray" size={24} />
                <span className="font-lato font-bold text-lg text-card-foreground">Market Insights</span>
              </div>
              <div className="flex items-center gap-3 bg-card backdrop-blur-sm px-6 py-4 rounded-full shadow-lg">
                <Users className="text-periwinkle-blue" size={24} />
                <span className="font-lato font-bold text-lg text-card-foreground">Trusted by Artists</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8 bg-cream-beige">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center bg-card backdrop-blur-sm rounded-2xl p-12 mb-12 animate-fade-in">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-playfair font-bold text-card-foreground mb-6">
