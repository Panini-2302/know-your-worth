  ...
  return <div className="min-h-screen from-cream-beige via-white to-periwinkle-blue/30 bg-[t#FFF4E0] bg-[#fff4e0]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          change: '+1.8%',
          color: 'text-pink-600'
        }].map((metric, index) => <Card key={index} className="hover-lift">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          {/* Revenue Trends */}
          <Card className="hover-lift bg-sky-50">
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={revenueData}>
                    ...
                    <XAxis dataKey="month" />
                    <YAxis />
                    <Tooltip formatter={(value, name) => [name === 'revenue' ? `$${value}` : value, name === 'revenue' ? 'Revenue' : 'Artworks']} />
          ...
          <Card className="hover-lift">
            ...
            <CardContent className="bg-sky-50">
              <div className="space-y-4">
                {trendingStyles.map((style, index) => <div key={index} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600">
                      ...
                      <div className="flex-1">
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div className="bg-blush-rose h-2 rounded-full transition-all duration-500" style={{
                        width: `${style.demand}%`
                      }}></div>
                        </div>
                      </div>
          ...
          <Card className="lg:col-span-2 hover-lift">
            ...
            <CardContent className="bg-sky-50">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                value: '$2.5K',
                color: 'bg-periwinkle-blue'
              }].map((region, index) => <div key={index} className="text-center p-4 bg-gray-50 rounded-lg">
          ...
          <Card className="hover-lift">
            ...
            <CardContent className="bg-sky-50">
              <div className="space-y-4">
                ...
                event: 'Digital Art Week',
                date: 'Dec 15-20',
                impact: 'Medium'
              }, {
                event: 'Winter Exhibitions',
                date: 'Jan 5-25',
                impact: 'Medium'
              }, {
                event: 'NFT Conference',
                date: 'Jan 12-14',
                impact: 'High'
              }].map((event, index) => <div key={index} className="border-l-4 border-blush-rose pl-4 py-2">
                    <h4 className="font-lato font-semibold text-graphite-soft text-sm">
                      {event.event}
                    </h4>
                    <p className="text-xs text-gray-600">{event.date}</p>
                    <Badge className={`mt-1 ${event.impact === 'High' ? 'bg-blush-rose' : 'bg-periwinkle-blue text-graphite-soft'}`}>
                      {event.impact} Impact
                    </Badge>
                  </div>)}
              </div>
